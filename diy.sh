...
#git clone https://github.com/vernesong/OpenClash.git package/lean/luci-app-openclash  #openclash出国软件
svn co https://github.com/vernesong/OpenClash/trunk/luci-app-amlogic package/lean/luci-app-openclash  #openclash出国软件
